...
function saveTask() {
  ...
  const payload = {
    ...
    history: [
      ...(form.value.history ?? []),
      isCreateMode.value ? '새 컨텐츠 카드가 생성되었습니다.' : '카드 정보가 업데이트되었습니다.',
    ],
  }
      ...
      <section class="task-modal__dialog">
        <header class="task-modal__toolbar">
          ...
          <div class="task-modal__toolbar-actions">
            <button class="task-modal__share" type="button">Share</button>
        ...
        <div class="task-modal__body">
          <section class="task-modal__headline">
            <p class="task-modal__eyebrow">
              {{ isCreateMode ? '신규 카드 생성' : form.requirementId }}
            </p>
          ...
          <section class="task-modal__properties">
            ...
            <div class="task-modal__property task-modal__property--tags">
              <span>Tags</span>
              <div class="task-modal__control">
                <input v-model="tagsText" type="text" placeholder="design, web" />
            ...
            <button class="task-modal__custom-field" type="button">+ Add custom field</button>
          </section>
          ...
          <section class="task-modal__section">
            ...
            <textarea
              ...
              rows="5"
              placeholder="이 태스크는 타임 페이지의 빈 주간 처리 및 타임오프 변경 사항 구현을 포함합니다."
            />
          </section>
          ...
          <section class="task-modal__section">
            ...
            <div class="task-modal__attachments">
              ...
              >
                ...
                <button type="button" aria-label="첨부 삭제" @click="removeAttachment(index)">
                  X
                </button>
              </article>
        ...
        <footer class="task-modal__footer">
          <div class="task-modal__footer-left">
            <button v-if="!isCreateMode" type="button" @click="duplicateTask">Duplicate</button>
            <button
              v-if="!isCreateMode"
              type="button"
          ...
          <div class="task-modal__footer-actions">
            <button type="button" class="task-modal__secondary" @click="closeModal">Cancel</button>
            <button type="button" class="task-modal__primary" @click="saveTask">
              Save Changes
            </button>
          </div>
        </footer>
