...
const railClass =
  'grid gap-4 rounded-[20px] border border-[color:var(--border-color)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--panel-color)_94%,white),var(--panel-color))] px-5 py-5 shadow-[0_14px_34px_rgba(15,23,42,0.07)]'
const sectionCardClass =
  'grid gap-3 rounded-[16px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-color)_86%,white)] px-4 py-4'
const sectionSoftCardClass =
  'grid gap-3 rounded-[16px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_72%,white)] px-4 py-4'
const summaryCardClass =
  'grid gap-1 rounded-[16px] border px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]'
const queueItemClass =
  'grid gap-3 rounded-[16px] border px-4 py-4 text-left transition duration-200 hover:-translate-y-px hover:shadow-[0_10px_24px_rgba(15,23,42,0.08)]'
const badgeBaseClass =
  'inline-flex min-h-7 items-center justify-center rounded-full border px-2.5 text-[0.72rem] font-semibold tracking-[0.01em]'
const pillClass =
  'inline-flex min-h-7 items-center justify-center rounded-full border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_80%,white)] px-2.5 text-[0.72rem] font-semibold text-[color:var(--muted-text)]'
const ghostButtonClass =
  'inline-flex min-h-[2.5rem] items-center justify-center gap-2 rounded-[12px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-color)_90%,white)] px-3.5 text-sm font-semibold text-[color:var(--text-primary)] transition duration-200 hover:-translate-y-px hover:shadow-[0_8px_22px_rgba(15,23,42,0.08)]'
const primaryButtonClass =
  'inline-flex min-h-[2.8rem] items-center justify-center gap-2 rounded-[12px] border border-[color:var(--accent-color)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--accent-color)_88%,white),var(--accent-color))] px-4 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(15,23,42,0.16)] transition duration-200 hover:-translate-y-px disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:translate-y-0'
const inlineControlButtonClass =
  'inline-flex h-10 w-10 items-center justify-center rounded-[12px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-color)_88%,white)] text-base font-semibold text-[color:var(--text-primary)] transition duration-200 hover:-translate-y-px hover:shadow-[0_8px_20px_rgba(15,23,42,0.08)]'
const emptyStateClass =
  'grid gap-2 rounded-[16px] border border-dashed border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_60%,white)] px-5 py-6 text-sm text-[color:var(--muted-text)]'
const metaRowClass =
      ...
      <template v-if="selectedItem?.type === 'qa'">
        <section class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          ...
          >
            ...
            <p
              class="rounded-[14px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-color)_90%,white)] px-4 py-4 text-sm leading-7 text-[color:var(--text-secondary)]"
            >
        ...
        <article :class="sectionCardClass">
          ...
          <ul class="grid gap-2 text-sm leading-6 text-[color:var(--text-secondary)]">
            <li
              ...
              :key="change"
              class="rounded-[12px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_68%,white)] px-3 py-3"
            >
              {{ change }}
            </li>
          </ul>
        ...
        <article :class="sectionCardClass">
          ...
          <div class="grid gap-3 lg:grid-cols-4">
            <div
              ...
              :key="step.id"
              class="grid min-h-[74px] content-center gap-1 rounded-[14px] border px-4 py-3 text-left"
        ...
        <article :class="sectionCardClass">
          ...
          <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            <button
              ...
              type="button"
              class="grid gap-1 rounded-[14px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-color)_90%,white)] px-4 py-4 text-left transition duration-200 hover:-translate-y-px hover:shadow-[0_8px_20px_rgba(15,23,42,0.08)]"
      ...
      <template v-else-if="selectedItem?.type === 'generator'">
        <section class="grid gap-4 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <article :class="sectionCardClass">
            ...
            <div
              class="grid gap-3 rounded-[14px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_72%,white)] px-4 py-4"
            >
              <span
                class="text-[0.72rem] font-semibold uppercase tracking-[0.08em] text-[color:var(--muted-text)]"
                >요일 분배 규칙</span
        ...
        >
          ...
          <div class="grid gap-3 lg:grid-cols-2">
            <article
              ...
              :key="item.previewId"
              class="grid gap-3 rounded-[14px] border px-4 py-4"
        ...
        <article :class="sectionCardClass">
          ...
          <div class="grid gap-3 sm:grid-cols-5">
            <div
              ...
              :key="index"
              class="grid justify-items-center gap-2 rounded-[14px] border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--panel-muted)_70%,white)] px-3 py-4"
            >
              <small
                class="text-[0.72rem] font-semibold uppercase tracking-[0.08em] text-[color:var(--muted-text)]"
              >
              ...
              <div
                class="flex h-[118px] w-full items-end rounded-[12px] bg-[color:color-mix(in_srgb,var(--panel-color)_88%,white)] px-2 py-2"
              >
                <span class="w-full rounded-[10px]" :style="generatorBarStyle(count, index)" />
              </div>
              <strong class="text-sm font-semibold text-[color:var(--text-primary)]">{{
                count
              }}</strong>
